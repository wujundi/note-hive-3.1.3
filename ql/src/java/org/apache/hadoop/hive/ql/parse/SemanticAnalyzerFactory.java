...
public final class SemanticAnalyzerFactory {
  ...
  public static BaseSemanticAnalyzer get(QueryState queryState, ASTNode tree) throws SemanticException {
    BaseSemanticAnalyzer sem = getInternal(queryState, tree); // 根据语法树的类型来选择语义分析器
  ...
  private static BaseSemanticAnalyzer getInternal(QueryState queryState, ASTNode tree) // 根据语法树的类型来选择语义分析器
